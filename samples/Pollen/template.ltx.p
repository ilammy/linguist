...
\date{◊(unless (not (select-from-metas 'doc-publish-date metas)) (pubdate->abbr-english (select-from-metas 'doc-publish-date metas)))}  % if the \date{} command is left out, the current date will be used
